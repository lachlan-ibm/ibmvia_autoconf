    ...
    def _update_host_file(self, entries):
        for entry in entries:
            ...
            if rsp.success == True:
                ...
                track_failure('appliance', 'host_file', rsp, entry)
    ...
    def date_time(self, config):
        if config.date_time != None:
            ...
            if rsp.success == True:
                ...
                track_failure('appliance', 'date_time', rsp, config.date_time)
    ...
    def cluster(self, config):
        if config.config_database != None:
            ...
            if rsp.success == True:
                ...
                track_failure('appliance', 'cluster/confdb', rsp, methodArgs)
