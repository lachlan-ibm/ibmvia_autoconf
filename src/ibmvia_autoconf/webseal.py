...
class WEB_Configurator(object):
    ...
    def _configure_stanza(self, proxy_id, config):
        for entry in config:
            if entry.operation == "delete":
                ...
                track_failure('webseal', 'proxy - stanza', None, entry)
    ...
    def wrp(self, runtime, proxy):
        ...
        if self.factory.is_docker() == False:
            ...
            if rsp.success == True:
                ...
                track_failure('webseal', 'restart_instance', rsp, proxy)
    ...
    def runtime(self, runtime):
        ...
        if rte_status.json['status'] == "Unconfigured" or runtime.override_config == True:
            ...
            if rsp.success == True:
                ...
                track_failure('webseal', 'runtime', rsp, runtime)
    ...
    def rsa(self, rsa_config):
        ...
        if rsp.success == True:
            ...
            track_failure('webseal', 'rsa', rsp, rsa_config)
